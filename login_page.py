...
class LoginPage:
    ...
    def authorization(self, user_name, password):
        # ввод Username
        input_user_name = WebDriverWait(self.driver_chrome, 30).until(
        ...
        # ввод Password
        input_password = WebDriverWait(self.driver_chrome, 30).until(
        ...
        click_login = WebDriverWait(self.driver_chrome, 30).until(
